...
#====================API-KEYS=====================
GOOGLE_API = st.sidebar.text_input("Google-API",type = "password")
...
def Search_latest_info(query):
  ...
  news or content from wedsite
  using tavily, heplful to check
  trending content"""
...
with tab1:
  ...
  st.image("Image.jpeg")
  if st.button("Click or generate: "):
    with st.spinner():
...
with tab3:
  ...
  if st.button("click to generate:")01.:
    with  st.spinner("Running Agent.."):
